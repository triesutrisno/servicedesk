    ...
    public function detail($id)
    {
        $datas = DB::table('tiket as a')
            ...
            if($id=='1'){
                ...
                $datas->where('a.updated_at', '>=', date("Y-m-01"))->where('tiketStatus', '=', '7')->orWhere('tiketStatus', '=', '10');
            }elseif($id=='7'){
                ...
                $datas->where('a.updated_at', '>=', date("Y-01-01"))->where('tiketStatus', '=', '7')->orWhere('tiketStatus', '=', '10');
            }elseif($id=='11'){
