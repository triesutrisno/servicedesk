            ...
            <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 grid-margin ">
                        @if ($requestLayanan == 'all' || $requestLayanan == '')
                          <?php
                        ...
                        @else
                            <?php
                            $filterLayanan = '&layanan[]=' .$requestLayanan;
                            ?>
                        @endif
                        <a href="{{ 'tiket2?tgl_create=' . date('m/d/Y') . ' - ' . date('m/d/Y') .$filterLayanan }}"
                        {{-- <a href="{{ route('tiket2.index', ['tgl_create' => date('m/d/Y') . ' - ' . date('m/d/Y'), 'layanan' =>$requestLayanan]) }}" --}}
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 grid-margin ">
                        ...
                        @else
                            ...
                            ?>
                        @endif
                        <a href="{{ 'tiket2?tgl_create=' . date('m/01/Y') . ' - ' . Carbon\Carbon::now()->endOfMonth()->format('m/d/Y') .$filterLayanan }}"
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 grid-margin ">
                      ...
                      @else
                          ...
                          ?>
                      @endif
                      <a href="{{ 'tiket2?tgl_create=' . date('01/01/Y') . ' - ' . date('12/31/Y') .$filterLayanan }}"
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 grid-margin">
                      ...
                      @else
                          ...
                          ?>
                      @endif
                      <a href="{{ 'tiket2?tgl_update=' . date('01/01/Y') . ' - ' . date('12/31/Y') .'&status[]=7&status[]=8' .$filterLayanan }}"
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 grid-margin">
                      ...
                      @else
                          ...
                          ?>
                      @endif
                      <a href="{{ 'tiket2?tgl_update=' . date('m/01/Y') . ' - ' . Carbon\Carbon::now()->endOfMonth()->format('m/d/Y') .'&status[]=7&status[]=8' .$filterLayanan }}"
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 grid-margin">
                      ...
                      @endif
                      {{-- <a href="{{ 'tiket2?tgl_update=' . date('01/01/Y') . ' - ' . date('12/31/Y') .'&status[]=7&status[]=8' .$filterLayanan }}" --}}
                        <a href="{{ 'tiket2?status[]=4&status[]=6&status[]=11'.$filterLayanan }}" style='color:#000000;text-decoration:none'>
                            <div class="card card-statistics">
                                <div class="card-body">
                                    <div class="clearfix">
                                        <div class="float-left">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 grid-margin">
                      ...
                      @else
                          ...
                          ?>
                      @endif
                        <a href="{{ 'tiket2?tgl_update=' . date('01/01/Y') . ' - ' . date('12/31/Y') . '&status[]=3&status[]=5&status[]=10' . $requestLayanan }}"
                            style='color:#000000;text-decoration:none'>
                            <div class="card card-statistics">
                                <div class="card-body">
                                    <div class="clearfix">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 grid-margin">
                      ...
                      @else
                          ...
                          ?>
                      @endif
                        <a href="{{ 'tiket2?status[]=9' . $requestLayanan}}" style='color:#000000;text-decoration:none'>
                            <div class="card card-statistics">
                                <div class="card-body">
                                    <div class="clearfix">
                                        <div class="float-left">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 grid-margin">
                      ...
                      @else
                          ...
                          ?>
                      @endif
                        <a href="{{ 'tiket2?status[]=1' .$requestLayanan }}" style='color:#000000;text-decoration:none'>
                            <div class="card card-statistics">
                                <div class="card-body">
                                    <div class="clearfix">
                                        <div class="float-left">
