                        ...
                        <div class="card-body">
                            ...
                            <!-- <div class="form-group">
                                <label for="ServiceSubStatus" class="col-md-4 control-label">Standart
                                    Penyelesaian</label>
                                <div class="col-md-6">
                                    <input type="time" class="form-control" name="StandartPenyelesaian" />
                                    <div class="input-group mb-3">
                                        <input type="number" class="form-control" placeholder="Standart Penyelesaian"
                                            aria-label="Standart Penyelesaian" aria-describedby="basic-addon2"
                                            name="StandartPenyelesaian" value="{{ $data->StandartPenyelesaian }}">
