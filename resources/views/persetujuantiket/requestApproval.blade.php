...
<div class="row" style="margin-top: 2px;">
    <div class="col-lg-12 grid-margin stretch-card">
        ...
        <div class="card-header p-1" style="background: #000080;"></div>
            <div class="card-body">
                <form method="POST" action="{{ url('persetujuantiket/requestApproval') }}/{{ $data[0]->tiketId }}" enctype="multipart/form-data">
                {{ csrf_field() }}
                    ...
                    <br />
                    <div class="form-group">
                        <label for="tiketNikTeknisi" class="col-md-4 control-label">Choose Name Approval</label>
                    ...
                    <div class="form-group">
                        <label for="keterangan" class="col-md-4 control-label">Remark</label>
                        <div class="col-md-6">
                            <textarea class="form-control" required id="keterangan" name="remark" rows="6"></textarea>                            
                        </div>
                    </div>
                    <div class="form-group">
